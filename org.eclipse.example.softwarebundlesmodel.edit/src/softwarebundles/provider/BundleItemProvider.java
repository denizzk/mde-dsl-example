...
/**
 * This is the item provider adapter for a {@link softwarebundles.Bundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SoftwarebundlesPackage.Literals.BUNDLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundle_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundle_components_feature", "_UI_Bundle_type"),
				 SoftwarebundlesPackage.Literals.BUNDLE__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
