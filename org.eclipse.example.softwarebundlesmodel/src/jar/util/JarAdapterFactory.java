...
public class JarAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected JarSwitch<Adapter> modelSwitch =
		new JarSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link jar.Local <em>Local</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link jar.Remote <em>Remote</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
